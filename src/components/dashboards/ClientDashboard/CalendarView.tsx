...
import { Clock, MapPin, User, Calendar as CalendarIcon, Menu, X } from 'lucide-react';
...
const CalendarView = () => {
  ...
  const API_URL = `${import.meta.env.VITE_API_URL}/api/client/calander/events/`;
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900">Your Calendar</h1>
          ...
          <div className="w-80 order-1 md:order-2 hidden md:block">
            <Card className="border border-gray-200">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-medium text-gray-900">Your Events</CardTitle>
              </CardHeader>
